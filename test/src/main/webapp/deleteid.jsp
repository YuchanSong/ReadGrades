...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg" style="font-size:2vh;">
    <i class="fa fa-exclamation-triangle" style="color:red;"></i>탈퇴를 누르시면 모든 데이터가 삭제됩니다.</p>
    ...
    <form action="../home.jsp" method="post">
      ...
      <div class="box-footer" style="padding-bottom:0px;">
                ...
                <button type="submit" class="btn pull-right" style="width:100px; background:red; color:white;">탈퇴</button>
              </div>
    </form>
